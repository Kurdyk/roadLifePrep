...
import { accueilPath, authentificationPath, logoutPath, usersPath, roadsPath, sensorPath, interventionPath, newInterventionPath, teamPath } from './const'
  ...
  return (
    <Box id="routeBox">
        <Routes>
            ...
            <Route path={usersPath} element={<RoleProtectionComponent children={<UsersComponent />} mapKey={'role'} role={'collectivite'} />} />
